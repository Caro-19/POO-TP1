...
public class TestTrabajo1 {
    public static void main(String[] args) {
        ...
        //     Cheque cheque1 = new Cheque(50000, "Banco Galicia", LocalDate.of(2026, 12, 31));
        //     System.out.println(cheque1);

        //     Cheque cheque2 = new Cheque(100000, "Banco Santander", LocalDate.of(2026, 8, 25));
        //     System.out.println(cheque2);
        // System.out.println("######################Clase Cheque funciona correctamente######################\n");    
        ...
        System.out.println("######################Test de la clase CuentaConvertibilidad######################");
            ...
            System.out.println(cuentaConvertibilidad2);// saldo:4200 saldoEnDolares:0.57
